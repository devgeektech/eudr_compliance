...
export const ledgerCards_ro = [
  {
    ...
    points: [
      ...
      "Luați măsuri concrete pentru a reduce sau elimina riscurile identificate",
      "Păstrați evidențele timp de cel puțin 5 ani",
      "Depuneți declarația de diligență înainte de introducerea pe piață a bunurilor",
    ],
  },
  {
    id: 2,
    name: "Trasabilitate",
    title: `Trasabilitatea înseamnă posibilitatea de a urmări un produs până la parcela specifică de teren unde a fost produs. Acest lucru permite autorităților și companiilor să verifice că produsul nu provine din terenuri recent defrișate sau degradate.`,
    icon: LedgerTraceability,
    bg: "/About/images/plant2.jpg",
  ...
  },
  {
    ...
    points: [
      "Furnizați coordonate GPS (latitudine și longitudine)",
      "Acoperiți toate parcelele mai mari de 4 hectare",
      "Parcele mai mici pot fi reprezentate ca punct",
      "Asigurați acuratețea identificării terenului",
      "Utilizat pentru verificarea defrișărilor",
    ],
  },
];
