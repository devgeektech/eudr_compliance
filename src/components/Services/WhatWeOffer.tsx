    ...
    <section className="w-full bg-[#1A1A1C] py-20 px-6 md:px-10 lg:px-16">
      <div className="mx-auto w-full max-w-[75%]">
        <div className="mb-14 text-center">
          <h2 className="text-4xl md:text-5xl font-semibold text-white">What We Offer</h2>
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-white/70">
            We help businesses confidently prepare for EUDR compliance with expert consulting,
            structured systems, and end-to-end operational support.
          </p>
        </div>
