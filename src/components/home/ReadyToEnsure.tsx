    ...
    <section className="relative w-full min-h-[450px] flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 lg:px-[240px] py-20 text-white flex flex-col items-center text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
         <a
  href="https://mail.google.com/mail/?view=cm&fs=1&to=contact@eudrcompliance.com&su=EUDR%20Consultation%20Request"
  target="_blank"
  rel="noopener noreferrer"
  className="px-6 py-3 rounded-lg bg-[#BF9655] text-white font-medium hover:opacity-90 transition inline-flex items-center justify-center"
>
  {t("ready.bookCall")}
</a>
          <Link href="/contact">
