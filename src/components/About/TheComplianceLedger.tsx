...
import { ledgerCards } from "@/src/constants";
    ...
    <section className="w-full bg-[#1A1A1C] py-14 md:py-20 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
      ...
      <div className="text-center max-w-3xl mb-10 md:mb-16">
        ...
        <p className="text-gray-300 mt-3 md:mt-4 text-sm sm:text-base leading-relaxed">
          Track and manage all your EUDR compliance data in one place
        </p>
      </div>
        ...
        {ledgerCards.map((card, index) => (
          ...
          >
            ...
            <div className="relative w-full lg:w-1/2 h-[320px] sm:h-[380px] lg:h-[430px] group overflow-hidden">
              ...
              {/* CENTER CONTENT */}
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-5 sm:px-8 text-white">
                <p className="text-xs sm:text-sm tracking-[2px] uppercase opacity-80">
                  Concept 0{index + 1}
                </p>
